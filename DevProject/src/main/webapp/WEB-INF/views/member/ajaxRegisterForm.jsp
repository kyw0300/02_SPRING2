...
<body>
	...
	<form action="">
		<p>userId : <input type="text" name="userId" value="jdm999" id="userId"/></p>
		<p>password : <input type="text" name="password" value="9999" id="password"/></p>
	</form>
...
$(function(){
	...
	$("#registerBtn01").on("click",function(){
		$.get("/ajax/register/jdm999", function(result){
	...
	$("#registerBtn09").on("click", function(){
		...
		var userObject = {
			...
			password : password,
			cardList : [
				{no : "12345", validMonth : "2021-10-17"},
				{no : "67890", validMonth : "2025-07-03"}
			]
		};
