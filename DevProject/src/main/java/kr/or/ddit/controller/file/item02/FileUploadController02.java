...
public class FileUploadController02 {
	 ...
	 * 		1. 파일 업로드 구현 설명
	 * 	
	 * 			- 파일 업로드 목록 화면 컨드롤러 메소드 만들기(item2List:get)
	 ...
	 * 			- 파일 업로드 등록 화면 컨드롤러 메소드 만들기(item2RegisterForm:get)
	 * 			- 파일 업로드 등록 화면 만들기(item2/register.jsp)
	 * 			- 파일 업로드 등록 기능 컨드롤러 메소드 만들기(item2Register:post)
	 ...
	 * 			- 여기까지 확인!
	 * 
	 * 			- 파일 업로드 수정 화면 컨드롤러 메소드 만들기(item2ModifyForm:get)
	 ...
	 * 
	 * 			- 파일 업로드 수정 기능 컨드롤러 메소드 만들기(item2Modify:post)
	 ...
	 * 			- 여기까지 확인!
	 * 
	 * 			- 파일 업로드 삭제 화면 컨드롤러 메소드 만들기(item2RemoveForm:get)
	 ...
	 * 
	 * 			- 파일 업로드 삭제 기능 컨드롤러 메소드 만들기(item2Remove:post)
	...
	// root-context.xml에서 설정한 uploadPath 빈 등록 path 경로를 사용한다.(value로 설정했던 값)
