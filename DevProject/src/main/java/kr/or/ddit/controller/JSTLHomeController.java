...
public class JSTLHomeController {
	 ...
	 * 		<fn:containsIgnoreCase>	|	지정한 문자열이 대문자/소문자를 구분하지 않고 포함되있는지 판단한다.	
	 ...
	 * 
	 * 6. 코어태그
	 * - 조건 분기나 반복처리 그리고 변수의 지정 등과 같이 논리적인 처리를 위해 사용되는 스크립트 코드를 대체하기 위한 태그를 제공합니다.
	 * 
	 * 		1) <c:out>
