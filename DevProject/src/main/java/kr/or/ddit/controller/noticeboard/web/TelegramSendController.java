...
public class TelegramSendController {
	...
	public void sendGet(String name, String title) throws IOException, UnsupportedEncodingException {
		String chatId = "-987525737";
		String urlName = "https://api.telegram.org/bot5956568521:AAFeoMno8FFMMyxbi2WvN01VJQJqjq_qDBM/sendMessage";
		String text = "";
